...
class HomeItem4 extends Component {
  constructor(props) {
      super(props);
      this.state = {
        tap: false
  ...
  render(){
    const images = [
      {
        original: 'https://s-media-cache-ak0.pinimg.com/736x/d1/a6/64/d1a664bca214bf785a293cbc87950fc4.jpg'

      },
      {
        original: 'https://s-media-cache-ak0.pinimg.com/736x/f5/a0/62/f5a0626a80fe6026c0ac65cdc2d8ede2.jpg'
      },
      {
        original: 'https://firebasestorage.googleapis.com/v0/b/thamcook.appspot.com/o/images%2FhomeBox%2Fgokubir.jpg?alt=media&token=30b52318-8b4f-4c57-a6fe-90b8b8db390a'
      }
    ];
    return(
      <div className="home-item">
        <div className="bl_inline svg3">
          ...
          <svg version="1.1" id="svg_ic4" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px"
          	 viewBox="0 0 612 612" >
          <g>
          	<g>
          ...
          <div id="tbook" className="item-box-title">
